...
class SpeciesName(ValidationTestCase):
    ...
    def test_name_type(self):
        ...
        for species in self.species:
            if 'name' in species:
                self.assertIsInstance(species['name'], unicode)

    def test_name_set(self):
        """Verify the species name is set"""
        for species in self.species:
            if 'name' in species:
                self.assertTrue(species['name'])

    def test_name_stripped(self):
        """Verify the species name has no extra whitespace."""
        for species in self.species:
            if 'name' in species:
                self.assertStripped(species['name'])
    ...
    def test_scientific_name_genus(self):
        ...
        for species in self.species:
            if 'scientific_name' in species:
                ...
                self.assertRegexpMatches(genus, r'[A-Z][a-z]+')
    ...
    def test_scientific_name_species(self):
        ...
        for species in self.species:
            if 'scientific_name' in species:
                ...
                self.assertRegexpMatches(genus, r'[a-z]+')
